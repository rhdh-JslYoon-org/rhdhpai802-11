...
2) Go to the `Data Science Projects` section and access your application's project named `rhdhpai802-11`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `rhdhpai802-11-notebook`.
...
5) In the terminal, run `cd rhdhpai802-11` to navigate to your sample app's directory.
